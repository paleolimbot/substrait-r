...
or using [`substrait_create()`](reference/substrait_create.md):
...
us to get started writing good
[`as_substrait()`](reference/as_substrait.md) and
[`from_substrait()`](reference/as_substrait.md) methods for various
types of R objects.
